                ...
                {selectedLead ? (
                  <div className="rounded-2xl border border-stone-800 bg-stone-900/15 p-6 space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 text-xs font-mono">
                      {/* Left: Contact Info */}
                      <div className={`space-y-2.5 p-3 rounded-xl border border-stone-850/60 bg-stone-950/20 ${selectedLead.customerCompany === 'Direct Web Inquiry' ? 'sm:col-span-2' : ''}`}>
                        <p className="text-[9px] text-amber-500 font-bold uppercase mb-1.5">Lead Details</p>
                      ...
                      {/* Right: Sourcing material specs */}
                      {selectedLead.customerCompany !== 'Direct Web Inquiry' && (
