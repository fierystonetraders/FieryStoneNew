...
export default function WebsiteView({
  ...
  const handleProductLeadSubmit = (e: React.FormEvent) => {
    ...
    if (leadQuantity < requiredMin) {
      setFormError(`Minimum order limit for this Granite configuration is ${requiredMin.toLocaleString()} SQFT to optimize FOB container weight limits.`);
      return;
    }
        ...
        <>
          ...
          <section id="hero" className="relative flex min-h-[80vh] items-center justify-center overflow-hidden border-b border-stone-900 px-6 py-20 pb-32">
            ...
            <div className="absolute inset-0 z-0 opacity-30">
              <img 
                src="https://images.unsplash.com/photo-1610018556010-6a11691bc905?w=1600&auto=format&fit=crop&q=80" 
                      ...
                      >
                        <div className="relative h-64 w-full overflow-hidden bg-stone-950">
                          ...
                          <div className="absolute top-4 left-4 flex flex-col gap-1.5 bg-stone-950/50 p-1.5 rounded-lg">
                            ...
                            <span className="rounded-md bg-stone-950/90 text-stone-200 px-2 py-0.5 text-[8px] font-mono border border-stone-800 text-center">
                              Global Min: {globalMinQuantity || 500} SQFT
                            </span>
                          </div>
                  ...
                  >
                    <div className="relative h-64 w-full overflow-hidden bg-stone-950">
                      ...
                      <div className="absolute top-4 left-4 flex flex-col gap-1.5">
                        ...
                        <span className="rounded-md bg-stone-950/85 text-stone-200 px-2 py-1 text-[9px] font-mono border border-stone-800">
                          Global Min: {globalMinQuantity || 500} SQFT
                        </span>
                      </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1588854337236-6889d631faa8?w=1000&auto=format&fit=crop&q=80"
