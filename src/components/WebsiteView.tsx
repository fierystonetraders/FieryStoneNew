...
export default function WebsiteView({
  ...
  // Reset activeImgIndex when selectedProduct changes
  useEffect(() => {
    setActiveImgIndex(0);
  }, [selectedProduct]);

  // Autoscroll logic for multiple product images when modal is open
  useEffect(() => {
    if (!selectedProduct) return;
    const images = selectedProduct.images && selectedProduct.images.length > 1 
          ...
          <section id="products-homepage-section" className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="mt-3 text-stone-400 text-xs sm:text-sm">
                Each signature raw slab is selected for exceptional petrography and mineral pattern coherence.
              </p>
            </div>

            {homepageProducts.length === 0 ? (
              <div className="rounded-xl border border-stone-850 py-16 text-center max-w-xl mx-auto bg-stone-900/10">
                <p className="text-stone-400 font-medium">No products available</p>
              </div>
            ) : (
              <div>
            ...
            <div className="mx-auto max-w-7xl">
              <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
                <span className="text-sm font-bold uppercase tracking-widest text-amber-500 font-sans">
                  The {logoText || 'FieryStone'} Standard
                </span>
                ...
                <p className="text-stone-200 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto italic font-sans font-light">
                  "Every slab we export reflects India’s craftsmanship and nature’s artistry, flawlessly processed and precision-finished for modern global design."
                </p>
              </div>
          ...
          <div className="text-center md:text-left md:flex md:items-end md:justify-between mb-12">
            ...
            {activeProducts.length > 0 && (
              <div className="mt-6 md:mt-0 flex flex-wrap gap-2 overflow-x-auto justify-center font-mono">
                {graniteTypes.filter(g => g.active).length > 0 && (
                  <button
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-16 font-sans">
            ...
            <h2 className="mt-2 text-4xl font-light tracking-tight text-white mb-6 font-display italic">
              About {logoText || 'FieryStone'}
            </h2>
            <div className="mt-4 text-stone-300 max-w-3xl mx-auto text-[15px] leading-relaxed space-y-4 font-sans">
              <p>
                At {logoText || 'FieryStone'}, we bring India’s finest granite to the world — sourced from top quarries, expertly processed, and precision-finished for modern architecture and design.
              </p>
              <p>
                Whether it’s for commercial spaces, residential interiors, or monumental projects, {logoText || 'FieryStone'} delivers consistent export quality, on-time shipments, and competitive pricing that aligns with your project goals.
              </p>
            </div>
            ...
            <div className="mt-8 border-t border-stone-800/80 pt-6 max-w-lg mx-auto font-sans">
              <h3 className="text-sm font-bold text-white tracking-widest uppercase mb-1 font-sans">
                {(() => {
                  const brand = (logoText || 'FieryStone').toUpperCase();
                  if (brand.includes('TRADERS') || brand.includes('PRIVATE LIMITED') || brand.includes('PVT. LTD.')) {
                    return brand;
                  }
                  return `${brand} TRADERS PRIVATE LIMITED`;
                })()}
              </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 font-sans">
              ...
              <div className="rounded-xl border border-stone-800 bg-stone-950 p-6">
                ...
                <p className="text-stone-300 text-xs leading-relaxed mt-2 font-light">
                  To stand across generations as India’s preeminent premium granite exporter; inspiring architects worldwide to shape monumental spaces with the raw, natural elegance and enduring quality of Indian granite.
                </p>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-xl border border-stone-800 bg-stone-950 p-6 relative overflow-hidden group hover:border-amber-500/20 transition">
              ...
              <h4 className="text-base font-bold text-white uppercase font-sans">{logoText || 'FieryStone'} Traders (IND)</h4>
            ...
            <div className="rounded-xl border border-stone-800 bg-stone-950 p-6 relative overflow-hidden group hover:border-amber-500/20 transition">
              ...
              <h4 className="text-base font-bold text-white uppercase font-sans">{logoText || 'FieryStone'} Traders (US)</h4>
          ...
          <div className="lg:col-span-3 rounded-xl border border-stone-800 bg-stone-900/30 p-8 relative">
            ...
            {contactSuccess ? (
              <div className="bg-stone-950 border border-amber-500/40 p-6 rounded-lg text-center space-y-4">
                <CheckCircle2 className="h-10 w-10 text-amber-500 mx-auto" />
                <h4 className="text-stone-200 font-bold font-mono">INQUIRY SUBMITTED</h4>
      ...
      <footer id="web-footer" className="bg-stone-950 border-t border-stone-900 py-12 px-6">
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 items-center md:items-start gap-8 font-sans">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right gap-1.5 font-sans text-xs text-stone-500 md:self-end">
            <p>
              © 2026 {(() => {
                const brand = logoText || 'FieryStone';
                if (brand.toLowerCase().includes('traders') || brand.toLowerCase().includes('private limited') || brand.toLowerCase().includes('pvt')) {
                  return brand;
                }
                return `${brand} Traders`;
              })()}. All rights reserved.
            </p>
              ...
              <div className="p-6 md:p-8 bg-stone-900/30 border-r border-stone-800 flex flex-col justify-between">
                <div>
                  <div className="h-48 w-full rounded-xl overflow-hidden bg-stone-950 border border-stone-800 mb-6">
                    <img 
                      src={(selectedProduct.images && selectedProduct.images.length > 0 ? selectedProduct.images[activeImgIndex] : null) || selectedProduct.image} 
                  ...
                  {/* Thumbnail tiles above Specifications Sheet */}
                  {selectedProduct.images && selectedProduct.images.length > 1 && (
                    <div className="flex gap-1.5 overflow-x-auto pb-1.5 mb-4 max-w-full">
                      {selectedProduct.images.map((img, i) => (
                        <button
                          key={i}
                          type="button"
                          onClick={() => setActiveImgIndex(i)}
                          className={`h-10 w-14 rounded border transition overflow-hidden flex-shrink-0 cursor-pointer ${
                            activeImgIndex === i 
            ...
            {activeLegalPopup === 'disclaimer' && (
              <div className="space-y-4 font-sans">
                <div className="flex items-center gap-2 text-amber-500 font-sans">
                  ...
                  <h3 className="text-lg font-bold uppercase tracking-wider">Export Disclaimer</h3>
                </div>
