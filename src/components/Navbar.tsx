        ...
        >
          {logoUrl ? (
            ...
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded bg-amber-500 text-stone-950 font-sans font-black text-xs">
                F
              </div>
              <span className="text-sm font-black tracking-wider uppercase text-stone-100 font-sans">
                {logoText || 'FieryStone'}
              </span>
            </div>
          )}
          ...
          {currentView === 'website' ? (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg border border-stone-850 hover:border-amber-500/20 bg-stone-900 px-3 py-1.5 text-[10px] uppercase font-bold tracking-wider text-stone-300 hover:text-amber-500 transition cursor-pointer"
              >
              ...
              {isAdminLoggedIn && onLogout && (
                <button
                  onClick={onLogout}
                  className="flex items-center gap-1.5 rounded-lg border border-red-950 hover:border-red-500/30 bg-red-950/20 hover:bg-red-950/40 px-3 py-1.5 text-[10px] uppercase font-bold tracking-wider text-red-400 hover:text-red-300 transition cursor-pointer"
                  title="Logout Session"
                >
                  <LogOut className="h-3.5 w-3.5" />
                  <span>Logout</span>
