...
import { Flame, ShieldCheck, Mail, Globe, Settings, ClipboardList, Sparkles, Search, Menu, X } from 'lucide-react';
        ...
        <div id="nav-cta" className="flex items-center gap-3.5 flex-shrink-0">
          {currentView === 'website' ? (
            ...
            <button
              ...
              className="flex items-center gap-1 rounded-lg border border-stone-850 hover:border-amber-500/20 bg-stone-900 px-3 py-1.5 text-[10px] uppercase font-bold tracking-wider text-stone-300 hover:text-amber-550 transition cursor-pointer"
            >
