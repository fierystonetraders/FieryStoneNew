              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="bg-stone-900 border border-stone-850 rounded-xl p-5 shadow-lg space-y-4 font-sans">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Logo Information Notice */}
                    <div className="rounded-lg bg-stone-950/50 border border-stone-850 p-3.5 space-y-1">
                      <p className="text-[10px] text-amber-500 font-bold uppercase tracking-wider">Corporate Logo Configured</p>
                      <p className="text-[11px] text-stone-400 leading-relaxed font-sans">
                        The website is configured to use the static high-resolution corporate logo file <code className="text-amber-500 font-mono text-[10px] bg-stone-900 px-1 py-0.5 rounded">logo.png</code> inside your components folder to ensure pristine vector quality, transparency, and instant loading speeds.
                      </p>
                    </div>
                  </div>
                </div>
