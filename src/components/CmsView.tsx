                              ...
                              r.onload = () => {
                                if (typeof r.result === 'string' && onUpdateLogoUrl) {
                                  ...
                                  img.onload = () => {
                                    ...
                                    // Compresses beautifully to PNG to preserve transparent background on company logos
                                    const compressedDataUrl = canvas.toDataURL('image/png');
                                    onUpdateLogoUrl(compressedDataUrl);
                                    } else {
                                      onUpdateLogoUrl(r.result as string);
                                    }
                                  };
                                }
                              };
                      ...
                      <div className="pt-2 flex flex-col gap-2 border-t border-stone-850/50 text-xs">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <img src={logoUrl} alt="Logo preview" className="h-14 md:h-18 max-h-[72px] w-auto object-contain bg-stone-900 p-2 rounded-lg border border-stone-800 shadow-inner" />
