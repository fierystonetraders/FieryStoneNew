...
export const initialLeads: Lead[] = [
  {
    ...
    reminders: [
      { id: 'rem-1-1', date: '2026-06-19T10:00:00.000Z', notes: 'Send high-res slab photos from Visakhapatnam Stockyard Yard C.', completed: false, sent: false }
    ],
    emailLogs: [
      {
        id: 'elog-1-1',
  ...
  },
  {
    ...
    reminders: [
      { id: 'rem-2-1', date: '2026-06-17T09:00:00.000Z', notes: 'Initial phone check-in and location eligibility verify.', completed: true, sent: true },
      { id: 'rem-2-2', date: '2026-06-18T14:00:00.000Z', notes: 'Follow up with shipping and handling rates for Visakhapatnam dispatch.', completed: false, sent: false }
    ],
    emailLogs: [
      {
        id: 'elog-2-1',
